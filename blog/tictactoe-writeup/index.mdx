...
This one is an example of a software product/feature documentation that includes a write-up of available features, a short installation guide and a demo video for a product - a [Tic Tac Toe CLI game](https://github.com/chivoi/tictactoe) that I built with a colleague for a code club at work. <!-- truncate -->

:::note[**Quick facts**]
**Target Audience**: Anyone with basic command line knowlede.

**My contribution**: Created this document from scratch, including a demo screencast and other assets.

**AI usage**: I used gen AI was used to scaffold this doc and then heavily edited it.
:::
___
## Intro
