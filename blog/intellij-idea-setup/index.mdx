...
This is an internal guide I wrote at my former workplace for developers or any other IDE users on how to set up IntelliJ Idea to work with our Ruby on Rails codebase. <!-- truncate --> All sensitive information and details are edited from both images and text.
