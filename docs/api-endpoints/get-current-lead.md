...
This is a test/development endpoint that is called to get the name of the current lead for the given [Event](../resources-and-definitions.md#events).
...
A successful request will return `200 OK` response code and the name of the [Team Member](../resources-and-definitions.md#team-member) who is the current lead of your [Event](../resources-and-definitions.md#events):
